...
positpal::start("Group_9_CC2.Rmd")
```
...
1. **Abby Duggan** — 20399492
    + [BIOL343_CC2](https://github.com/abbyleeduggan/BIOL343_CC2)
1. **Rebecca Burns** — 20403917
    + [BIOL343_CC2](https://github.com/R-Burns2005/BIOL343_CC)
1.  **Eva Campbell** — 20421579
    + [BIOL343_CC2](https://github.com/EvaC315/Week03_CC2)
1.  **Adam New** — 20407310
    + [BIOL343_CC2](https://github.com/AdamNew1-tec/New-Repository)
1.  **Danica Rheault** — 20414884
    + [BIOL343_CC2](https://github.rheaultdanica/BIOL343_CC2)
...
----------------|---------------------|------
population_type | Population Type     | None
ovary_width     | Width of the Ovary  | mm
ovary_height    | Height of the Ovary | mm
flower_number   | Number of Flowers   | Count
...
```{r import-clean}
assn2_data <- read.csv("./data/A1_Data_Excel.csv", header=TRUE)

cc1_data <- assn2_data[1:46,c(1,5,6,8)]
...
The units of ovary area are mm$^2$. The units for both ovary width and ovary height are mm. 
...
area_means <- aggregate(
  ovary_area ~ population_type,
  data = cc1_data,
  mean
)

names(area_means) <- c("population_type", "ovary_area_mean")
...
```{r area-histogram, echo=F, warning=F}
library(ggplot2)
...
[Solanum pimpinellifolium](https://onq.queensu.ca/d2l/lms/dropbox/user/folder_submit_files.d2l?db=492536&grpid=1208702&isprv=0&bp=0&ou=1208667)
